			...
			<div class="wbcom-bp-addons-plugins-list">
				...
				<div class="wbcom-addon-plugins-inner-wrapper">
					...
					<div class="wbcom-addons-plugins-card">
						...
						<div class="wbcom-addons-card-details">
							<h2><?php esc_html_e( 'WB Polls', 'buddypress-polls' ); ?></h2>
							<p><?php esc_html_e( 'WB Polls lets you create engaging polls for your community via shortcodes, REST API, or BuddyPress activity streams.', 'buddypress-polls' ); ?></p>
							<div class="wbcom-addons-card-button">								
